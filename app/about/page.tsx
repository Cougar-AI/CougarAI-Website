        ...
        <section className="md:max-2xl:ml-32">
          ...
          <div className="grid grid-cols-2 gap-x-5 gap-y-5">
            {aboutUsCardInformation.map((cardTitle, index) => (
              <div key={index} className="relative flex flex-row gap-x-4 bg-snow rounded-md h-16 items-center overflow-hidden">
                <Image src="/Icons/chip_placeholder.svg" width={140} height={140} className="absolute mt-6 ml-44" alt="icon"></Image>
                <h1 className={satoshiBold.className + " text-cai-500 font-bold text-2xl text-center px-6 py-4"}>{cardTitle}</h1>
              </div>
            ))}
          </div>
