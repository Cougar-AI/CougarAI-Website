    ...
    return (
      <main className="bg-cai-400 min-h-screen flex flex-col md:max-2xl:grid lg:max-2xl:grid-cols-2">
        <section>
          ...
          <div className= {satoshiBold.className + " flex flex-col text-center md:max-2xl:text-start md:max-2xl:items-start items-center my-10 lg:max-2xl:my-24 md:max-2xl:pt-36 md:max-2xl:mx-32 mr-64 md:max-2xl:pb-16 w-screen"}>
