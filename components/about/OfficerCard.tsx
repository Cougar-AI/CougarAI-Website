    ...
    return(
        <div className="flex flex-col relative gap-y-0 bg-snow rounded-md h-64 w-52 md:max-2xl:h-[19rem] md:max-2xl:w-60 items-center md:max-2xl:p-8 p-1.5 overflow-hidden">
            ...
            <div className="flex flex-col items-center md:max-2xl:pb-2 z-40 h-1/2">
                <h1 className="text-cai-500 text-2xl text-center drop-shadow-sm md:max-2xl:pt-1.5 -pt-1.5">Zeel Engineer</h1>
                <h2 className="text-cai-500 text-xl text-center drop-shadow-sm md:max-2xl:pb-2 pb-1.5">President</h2>
                <SocialLink platform="LinkedIn" accountLink={'https://www.linkedin.com/'} platformIcon='/Icons/LinkedIn_icon.svg'></SocialLink>
            </div>
            <Image src="/Icons/neural-pattern-mistyrose.png" width={350} height={"0"} className="absolute h-[115%] scale-[155%] md:max-2xl:scale-[180%] rounded-tr-3xl top-0 ml-28 md:max-2xl:mt-20 mt-16 object-none z-0 select-none" alt="Card Pattern"></Image>
        </div>
    )
}
