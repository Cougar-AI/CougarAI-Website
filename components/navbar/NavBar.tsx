...
const NavBar = () => {
    return(
        <div className = {satoshiBold.className + " flex flex-row md:max-lg:flex-col gap-x-4 md:gap-y-1 lg:max-2xl:gap-x-9 h-auto text-white md:text-4xl lg:max-2xl:text-2xl align-baseline top-0 w-screen absolute pt-4 md:max-2xl:pt-8 items-center justify-center md:max-2xl:justify-normal md:max-2xl:items-start lg:max-2xl:ml-32 md:ml-32"}>
