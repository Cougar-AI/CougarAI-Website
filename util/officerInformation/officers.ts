...
export const officers = new Map<string, { name: string, role: string, linkedIn: string }>([
    ...
    ['Vice_President_Internal', { name: 'Ashish Job', role: 'Vice President Internal', linkedIn: 'https://www.linkedin.com/in/ashish-job/' }],
    ['Vice_President_External', { name: 'Denzel Wilson', role: 'Vice President External', linkedIn: 'https://www.linkedin.com/in/denzel-wilson-2422481a2/' }],
